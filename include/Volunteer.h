...
class Volunteer {
    public:
        ...
        virtual ~Volunteer(); //Our function  
        ...
        virtual string getType() const = 0; //Our function
...
class CollectorVolunteer: public Volunteer {
    ...
    public:
        ...
        void setTimeLeft(int otehrtimeleft);
        ...
        string getType() const override; //Our function
...
class DriverVolunteer: public Volunteer {
    ...
    public:
        ...
        void setDistanceLeft(int otherdistance);
